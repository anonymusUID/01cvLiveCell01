...
def main():
    ...
    input_img = out_dir+f"{file_name}/{file_name}{file_extension}"
    output_file_xl = out_dir+f"{file_name}/{file_name}"
    analyze_and_label_objects(input_img, out_dir, output_file_xl, option, file_name)
