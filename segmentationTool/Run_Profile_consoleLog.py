...
class ProfileManager:
    ...
    def create_widgets(self):
        ...
        self.output_dir_entry = tk.Entry(dir_frame, state='readonly')  # Make output directory read-only
            ...
            steps = [
                {
                    ...
                    "cmd": ["python", "y_imaprocSec.py", excel_file, input_image, color_spec, neighborhood, sv1, sv2, sv3, sv4, sv5, loc_specifier],
