...
# Save pickle version of the results
    ...
    pickle_path = output_file.rsplit('.', 1)[0] + ".pkl"
...
def main():
    ...
    image_path="C:/Users/Jit/AppData/Local/Programs/Python/Python312/z_My_Work/CV/Unsupervised_Learning_New_NUMBA/3411.jpg"
    #image_path="/home/surajit/CV/Unsupervised_Learning_NEW/341.jpg"
    color_spec='Perceived Grayscale Analysis'
    neighborhood_size=7
    loc_specifier="result_"
    ...
    try:
        ...
        # Your existing argument parsing and main logic here
        # For example:
        ...
        print(f"Parsed args: {excel_file}, {image_path}, {color_spec}, {neighborhood_size}, {sv1}, {sv2}, {sv3}, {sv4}, {sv5}")

        # Add any other processing code here...
    ...
    sv4=float(sys.argv[8])
    sv5=float(sys.argv[9])
    #output_dir=float(sys.argv[10])
    #flg_hough=float(sys.argv[11])
    """

    #print("sv3:",sv3,"sv4:",sv4,"sv5:",sv5)
    
    
    print("*************LOCATION_TEST-----------", loc_specifier)
    ...
    output_file = "Output/"+loc_specifier+"/"+f"{file_name}{file_extension}"
    os.makedirs(os.path.dirname(output_file), exist_ok=True)
    #output_file = "Output/"+f"out_{file_name}{file_extension}"
